// WADI-BOT v3.0 💮 - BY zapoteco1212 - github.com/zapoteco1212/WADI-BOT
...
function get(id){ if(!eco[id]) eco[id]={coins:1000,xp:0,level:1,last:0}; return eco[id] }
...
if(u.connection==='open') console.log('WADI-BOT ONLINE 💮')
...
┃ By zapoteco1212
┃ @${sender.split('@')[0]}
┃ 💰 ${user.coins} | XP ${user.xp} | Lv ${user.level}
┃ Pref: ${prefixes.join(' ')}
╰━━━━━━━━━━━━
...
${usedPrefix}dar owner 52xxx | ${usedPrefix}p | ${usedPrefix}owners
`.trim()
